...
idleoffsets = {'-290', '-60'} -- I recommend you have your idle offset at 0
leftoffsets = {'-130', '-50'}
downoffsets = {'-290', '-50'}
upoffsets = {'-370', '30'}
rightoffsets = {'-271', '-90'}
...
idle_xml_name = 'cryll idle0'
left_xml_name = 'cryll left0'
down_xml_name = 'cryll down0'
up_xml_name = 'cryll up0'
right_xml_name = 'cryll right0'
...
name_of_character_xml = 'cryll'
name_of_character = 'cry-ill'
name_of_notetype = 'cyrill'
