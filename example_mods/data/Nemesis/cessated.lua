...
idleoffsets = {'0', '4'} -- I recommend you have your idle offset at 0
leftoffsets = {'-10', '4'}
downoffsets = {'0', '5'}
upoffsets = {'-2', '1'}
rightoffsets = {'9', '2'}
...
idle_xml_name = 'cessare idle0'
left_xml_name = 'cessare left0'
down_xml_name = 'cessare down0'
up_xml_name = 'cessare up0'
right_xml_name = 'cessare right0'
...
name_of_character_xml = 'cessare'
name_of_character = 'cessare'
name_of_notetype = 'cessated'
