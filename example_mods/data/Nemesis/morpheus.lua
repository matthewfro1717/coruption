...
idleoffsets = {'1', '0'} -- I recommend you have your idle offset at 0
leftoffsets = {'229', '0'}
downoffsets = {'-226', '-150'}
upoffsets = {'-5', '167'}
rightoffsets = {'-200', '70'}
...
idle_xml_name = 'newmorpheusp3 idle0'
left_xml_name = 'newmorpheusp3 left0'
down_xml_name = 'newmorpheusp3 down0' 
up_xml_name = 'newmorpheusp3 up0'
right_xml_name = 'newmorpheusp3 right0'
...
name_of_character_xml = 'newmorpheusp3'
name_of_character = 'morphphase3'
name_of_notetype = 'morpheus'
