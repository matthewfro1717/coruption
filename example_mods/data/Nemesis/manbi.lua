...
idleoffsets = {'300', '0'} -- I recommend you have your idle offset at 0
leftoffsets = {'420', '0'}
downoffsets = {'250', '-60'}
upoffsets = {'288', '140'}
rightoffsets = {'19', '30'}
...
idle_xml_name = 'manbiphase4 idle'
left_xml_name = 'manbiphase4 left'
down_xml_name = 'manbiphase4 down'
up_xml_name = 'manbiphase4 up'
right_xml_name = 'manbiphase4 right'
...
name_of_character_xml = 'manbiphase4'
name_of_character = 'manbiphase4'
name_of_notetype = 'manbi'
