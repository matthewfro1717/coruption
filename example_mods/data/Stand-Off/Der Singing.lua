...
idle_xml_name = 'Der idle0'
left_xml_name = '"Der left0'
down_xml_name = 'Der down0'
up_xml_name = 'Der up0'
right_xml_name = 'Der right0'
...
name_of_character_xml = 'Der'
name_of_character = 'Der'
name_of_notetype = 'Der Sing'
name_of_notetype2 = 'Zan and Der Sing' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'idle', idle_xml_name, 16, true);
