...
-- float character
offset = 50 -- how much they move from the original position
speed = 1000 -- the higher this is, the slower they go

function onUpdate()
  setProperty(name_of_character .. '.y', y_position + offset * math.sin(getSongPosition() / speed))
end
...
idle_xml_name = 'exosphere idle0'
left_xml_name = 'exosphere left0'
down_xml_name = 'exosphere down0'
up_xml_name = 'exosphere up0'
right_xml_name = 'exosphere right0'
...
name_of_character_xml = 'exosphere'
name_of_character = 'exosphere'
name_of_notetype = 'Exosphere Sing'
name_of_notetype2 = 'Exosphere and Zand0r Sing' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
