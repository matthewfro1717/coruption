...
idle_xml_name = 'exophericbamb idle0'
left_xml_name = 'exophericbamb left0'
down_xml_name = 'exophericbamb down0'
up_xml_name = 'exophericbamb up0'
right_xml_name = 'exophericbamb right0'
...
name_of_character_xml = 'exophericbamb'
name_of_character = 'exophericbamb'
name_of_notetype = 'Exosphere and Bambi Sings'
name_of_notetype2 = 'duet' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'idle', idle_xml_name, 10, true);
	addAnimationByPrefix(name_of_character, 'singLEFT', left_xml_name, 13, false);
	addAnimationByPrefix(name_of_character, 'singDOWN', down_xml_name, 13, false);
	addAnimationByPrefix(name_of_character, 'singUP', up_xml_name, 13, false);
	addAnimationByPrefix(name_of_character, 'singRIGHT', right_xml_name, 13, false);
