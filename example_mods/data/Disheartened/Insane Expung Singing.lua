...
idle_xml_name = 'Exopunged idle0'
left_xml_name = 'Exopunged left0'
down_xml_name = 'Exopunged down0'
up_xml_name = 'Exopunged up0'
right_xml_name = 'Exopunged right0'
...
name_of_character_xml = 'Exopunged'
name_of_character = 'Exopunged'
name_of_notetype = 'Exopunged Sing'
