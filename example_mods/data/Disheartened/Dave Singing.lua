...
idle_xml_name = 'exo dave idle0'
left_xml_name = 'exo dave left0'
down_xml_name = 'exo dave down0'
up_xml_name = 'exo dave up0'
right_xml_name = 'exo dave right0'
...
name_of_character_xml = 'exo_dave'
name_of_character = 'phobiadave'
name_of_notetype = 'Dave Sing'
