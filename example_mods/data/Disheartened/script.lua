...
function onBeatHit()
    ...
    if curBeat > 176 then
        ...
        doTweenColor('epic4', 'background', 'FFFFFF', crochet * 0.001 - 0.01, 'linear')
    ...
    if curBeat > 624 and curBeat < 752 then
        ...
        doTweenColor('epic3', 'scoreTxt', '000000', crochet * 0.001 - 0.01, 'linear')
        for i = 0, 7 do
            noteTweenAngle('beatSpin' .. i, i, getPropertyFromGroup('strumLineNotes', i, 'angle') + 90,
                crochet * 0.001 - 0.01, 'expoOut')
        end
    end
    ...
    if curBeat > 752 and curBeat < 880 then
        ...
        triggerEvent('Change Scroll Speed', '1', '0.2');
        for i = 0, 7 do
            noteTweenAngle('beatSpin' .. i, i, getPropertyFromGroup('strumLineNotes', i, 'angle') - 45,
                crochet * 0.001 - 0.01, 'expoOut')
        end
    end
...
function onCreate()
    ...
    makeLuaText('dis', "Disheartened by Emperor Yami", 600, 680, 0)
