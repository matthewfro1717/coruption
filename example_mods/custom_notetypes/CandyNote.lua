function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'CandyNote' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'CandyNote_assets'); --Change texture
