function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Unstable Core' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'UnstableCoreNotes_assets'); --Change texture
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'Unstable Core' then
