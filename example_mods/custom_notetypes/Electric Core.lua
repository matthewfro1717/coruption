function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Electric Core' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'ElectricCoreNotes_assets'); --Change texture
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'Electric Core' then
