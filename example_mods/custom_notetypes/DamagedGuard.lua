function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'DamagedGuard' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'DamagedShield_assets'); --Change texture
