function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'GoldenGuard' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'GoldenGuard_assets'); --Change texture
