function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'RedBlast' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'RedBlastNote_assets'); --Change texture
