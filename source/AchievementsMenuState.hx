...
class AchievementsMenuState extends MusicBeatState
{
	...
	function changeSelection(change:Int = 0)
	{
		...
		var achievementTag:String = cast(Achievements.achievementsStuff[achievementIndex[curSelected]][2], String);
		if (achievementTag.contains("_unlock") && !Achievements.isAchievementUnlocked(achievementTag))
			descText.text = "?????";
		else
